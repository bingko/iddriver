	...
	<div class="row">
		<div class="col-lg-12">
			<h1 class="page-header"><?php echo $register['firstname'] ?></h1>
		</div>
			<div class="col-md-6">
				<table class="table">
					<tr>
						<td style="width:30%;text-align:right">ชื่อ-สกลุล</td>
			...
			<div class="col-md-2">
				<img style="width:100%;border:1px solid #f6f6f6" src="<?php echo empty($register['picture'])? base_url('img/No_Image_Available.png'):base_url('img/uploads/'.$register['picture']); ?>" alt=""/>
			</div>
    </div>
<script>
