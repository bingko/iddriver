            ...
            <aside>
              <div class="widget" id="index-left-menu">
                ...
                <div class="row" style="position:relative; top:-20px;">
                  <div class="col-lg-12 col-md-12 col-xs-12" ><a href="<?php echo site_url('main/register/1');?>"> <img src="<?php echo base_url()?>img/network/motorbike.jpg"  width="95%" class=""> </a></div>
                </div>
                ...
                <div class="row" style="position:relative; top:-60px;">
                  <div class="col-lg-12 col-md-12 col-xs-12" > <a href="<?php echo site_url('main/register/6');?>"> <img src="<?php echo base_url()?>img/network/truck.jpg"  width="95%" class=""> </a></div>
                </div>
              </div>
            </aside>
          </div>
